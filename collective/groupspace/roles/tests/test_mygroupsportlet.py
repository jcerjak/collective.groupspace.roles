...
from collective.groupspace.roles.tests.base_mygroupsportlet import \
    PloneTestCase
...
class TestRenderer(PloneTestCase):
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        # TODO: Pass any default keywoard arguments to the Assignment
        # constructor
    ...
    def test_render(self):
        ...
        r = self.renderer(
            context=self.folder, assignment=mygroupsportlet.Assignment())
